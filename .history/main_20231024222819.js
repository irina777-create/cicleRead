...
const numNat=+prompt(`кількість його парних дільників`);
 for(let i=2;numNat>=i;i++){
    if(numNat %i===0){
console.log(`кількість його парних дільників ${numNat}`);
    }
 }
 //Знайти сумму його парних дільників//
 const numberPar=+prompt(`сумма його парних дільників`);

 //Надракувати повну таблицю множення від 1 до 20//
 for(let i=1;i<=10;i++){
    for(let j=1;j<=10;i++){
const duble =i*j;
co
